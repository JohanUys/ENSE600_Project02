...
public class CompassInlayCanvas extends javax.swing.JPanel {
    ...
    protected void paintComponent(Graphics g) {
        ...
        double angleRad = Math.toRadians(90 - (directionId * 45) + 180); //180 added to flip to opposite angle
        int arrowLength = 15;
        ...
        // Wind speed text
//        String windText = wind.getSpeed() + " knots from the " + windDirection.name();
